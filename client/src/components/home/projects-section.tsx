  ...
  return (
    <section id="projects" className="py-16 md:py-24 relative overflow-hidden" ref={sectionRef}>
      ...
      <SpatialScrollContainer className="container mx-auto px-4">
        <SpatialScrollSection depth={0.5} className="mb-12">
          <AnimatedHeading
        ...
        <SpatialScrollSection depth={0.3} className="mb-8 flex justify-center">
        ...
        <SpatialScrollSection depth={0.4} className="mt-10 text-center">
          <Button 
            variant="link" 
